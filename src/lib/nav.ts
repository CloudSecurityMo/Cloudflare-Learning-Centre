...
export const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Network Flows", href: "/architecture/network-flows", status: "ready" },
      { label: "Security Layers", href: "/architecture/security-layers", status: "ready" },
      { label: "Hybrid Cloud", href: "/architecture/hybrid-cloud", status: "ready" },
      ...
      { label: "On-Prem + Cloudflare", href: "/architecture/on-prem", status: "ready" },
    ],
  },
  {
    label: "Labs",
    items: [
      ...
      { label: "Rate Limiting Lab", href: "/labs/rate-limit-lab", status: "ready" },
