...
export const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Request Lifecycle", href: "/labs/request-flow-simulator", status: "ready" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Origin Protection Lab", href: "/labs/origin-protection", status: "soon" },
      ...
      { label: "Request Flow Simulator", href: "/labs/request-flow-simulator", status: "ready" },
