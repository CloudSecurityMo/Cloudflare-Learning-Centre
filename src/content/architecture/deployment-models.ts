...
export const DEPLOYMENT_MODELS: DeploymentModel[] = [
  {
    ...
    httpFlow: "Full HTTP request is inspected by WAF, Bot Management, and Rate Limiting before being served from cache or forwarded to origin.",
    inspectionPoints: ["TLS termination", "WAF Managed + Custom Rules", "Bot Management", "Rate Limiting", "Cache eligibility check"],
